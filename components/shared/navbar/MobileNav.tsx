...
const NavContent = () => {
    ...
    return (
        <section className='flex h-full flex-col gap-6 pt-16 font-spaceGrotesk'>
                    ...
                    <div className="">
                        ...
                        <SignedOut>
                            <div className="flex flex-col gap-3">
                                ...
                                <SheetClose asChild>
                                    <Link href="/sign-up">
                                        <Button className='small-medium text-dark400_light900 min-h-[41px]  w-full rounded-lg border-2  border-orange-400 px-4 py-3 shadow-none'>
